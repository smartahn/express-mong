...
Mong.prototype.model = function(name) {
  ...
  if (!this.models[name]) this.models[name] = modelWrapper(this.req, model, { decorator: _decorators[name], keepOriginal: _keepOriginal });
...
module.exports = exports = mongFactory;
